...
\begin{document}
	...
	\begin{table}[H]
		...
		\begin{tabular}{@{}lll@{}}
			...
			Date     & The date the match took place                                                                                          &  \\ \midrule
			HomeTeam & The team playing at home                                                                                               &  \\
			AwayTeam & The team playing away                                                                                                  &  \\
			Season   & The season of the match                                                                                                &  \\
			HAS*     & \begin{tabular}[c]{@{}l@{}}Home Attacking Strength (If no suffix then average over all years, if\\   suf)\end{tabular} &  \\
			HDS*     & Home Defensive Strength                                                                                                &  \\
			HCON*    & Home Conversion Rate                                                                                                   &  \\
			HY*      & Home average yellow cards                                                                                              &  \\
			HR*      & Home average red cards                                                                                                 &  \\
			HAGG*    & Home aggressiveness                                                                                                    &  \\
			AAS*     & Away Attacking Strength                                                                                                &  \\
			ADS*     & Away Defensive Strength                                                                                                &  \\
			ACON*    & Away Conversion Rate                                                                                                   &  \\
			AY*      & Away average yellow cards                                                                                              &  \\
			AR*      & Away average red cards                                                                                                 &  \\
			AAGG*    & Away aggressiveness                                                                                                    &  \\
			FFPTSH   & Home Team average score for current matching for past n** matches                                                      &  \\
			FFPTSA   & Away Team average score for current matching for past n** matches                                                      &  \\
			FFHG     & \begin{tabular}[c]{@{}l@{}}Home Team average goals scored for current matching for past n**\\   matches\end{tabular}   &  \\
			FFAG     & \begin{tabular}[c]{@{}l@{}}Away Team average goals scored for current matching for past n**\\   matches\end{tabular}   &  \\
			PSH      & Home Team average score for past n** matches                                                                           &  \\
			SSH      & Home Team goal streak for the past n** matches                                                                         &  \\
			CSH      & Home Team conceded streak for past n** matches                                                                         &  \\
			HM       & Home Team Manager                                                                                                      &  \\
			AM       & Away Team Manager                                                                                                      &  \\
			HMN      & Nationality of Home Manager                                                                                            &  \\
			AMN      & Nationality of Away Manager                                                                                            &  \\ \bottomrule
		\end{tabular}
	\end{table}
	
	\subsection*{Appendix 3: Function Dictionary}
